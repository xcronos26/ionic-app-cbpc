...
var ComprovantePPage = /** @class */ (function () {
    ...
    ComprovantePPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-comprovante-p',template:/*ion-inline-start:"D:\cbpcapp\ionic-app-cbpc\src\pages\comprovante-p\comprovante-p.html"*/'<!--\n\n  Generated template for the ComprovantePPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>Envio de Comprovante</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <img *ngIf="img" [src]="img" alt="">\n\n  <button ion-button block (click) = "TirarFoto()">enviar comprivante</button>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\cbpcapp\ionic-app-cbpc\src\pages\comprovante-p\comprovante-p.html"*/,
            providers: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__intro__ = __webpack_require__(219);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_29__pages_detalhe_noticia_detalhe_noticia__["a" /* DetalheNoticiaPage */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_list_list__ = __webpack_require__(262);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_intro_intro__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_config_config__ = __webpack_require__(417);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var NoticiaPage = /** @class */ (function () {
    function NoticiaPage(navCtrl, navParams, servidor, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.servidor = servidor;
    ...
    NoticiaPage.prototype.getRetornar = function () {
        ...
        this.servidor.getPegarN()
            .subscribe(function (data) { return _this.noticiasWP = data; }, function (err) { return console.log(err); });
    };
    ...
    NoticiaPage.prototype.AbreNoticia = function (noticia) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__detalhe_noticia_detalhe_noticia__["a" /* DetalheNoticiaPage */], {
            noticia: noticia
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators__ = __webpack_require__(293);
...
var ServidorProvider = /** @class */ (function () {
    function ServidorProvider(http) {
        this.http = http;
        this.url = "http://cbpc.org.br";
        console.log('Hello ServidorProvider Provider');
    }
    ServidorProvider.prototype.getPegar = function () {
        return this.http.get(this.url + '/phpp/buscarIg.php').pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (res) { return res.json(); }));
    };
    ServidorProvider.prototype.getPegarN = function () {
        return this.http.get(this.url + '/wp-json/wp/v2/posts?_embed').pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (res) { return res.json(); }));
    };
